...
const DOM_Elements_As_Class = ["tr-Typestack--h1", "tr-Typestack--h2", "tr-Typestack--h3", "tr-Typestack--h4", "tr-Typestack--h5", "tr-Typestack--subline1", "tr-Typestack--subline2", "tr-Typestack--p1", "tr-Typestack--p1Bold", "tr-Typestack--p2", "tr-Typestack--p2Bold", "tr-Typestack--p3", "tr-Typestack--p3Bold"];
const typestack = {
    "tr-Typestack--h1": {
        fontSize: "44px",
        fontWeight: "500",
...
const DOM_Elements_Joined = document.querySelectorAll(`${DOM_Elements.join(",")}`);
...
for (const element of DOM_Elements_Joined) {
	...
	const classListArray = Array.from(element.classList);
  	const filteredClassNames = DOM_Elements_As_Class.filter(className => classListArray.includes(className));		
